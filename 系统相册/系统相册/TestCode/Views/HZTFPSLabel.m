...
+ (void)addFPSLableOnWidnow {
#ifdef DEBUG
    HZTFPSLabel *fpsLabel = [HZTFPSLabel new];
    UIWindow *window = [[UIApplication sharedApplication].delegate window];
    fpsLabel.frame = CGRectMake(5, CGRectGetHeight(window.frame) - (IS_IPhoneX() ? 104 : 80), 60, 20);
